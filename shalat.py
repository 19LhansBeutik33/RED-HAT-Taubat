# sholat Coy,Gak Takut Mati Lu
# Diretas By : 19LhansBeutik33
...
HARAP BACA DULU GAN !!!
-----------------------
Silahkan ReCode/Author,Ambilah Secara Annonym [TidakTerlihat]
...
def gettime():
      ...
      try:
                        ...
                        print(lg+'\nAstaghfirullah..\nMaaf Yah !!,Pakai Tools Ini Tergantung Amal'+x)
                        input(lg+'\nEnterin aja')
                        menu()
...
def banner():
      ...
      ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝
              {lw}INGAT!,SHALAT LAH SEBELUM DI SHALAT KAN{lg}
...
def update():
      banner()
      print(lr+'Jangan di cancell ya ustadz/ustadzah.. biar nggak error :*')
      print(lg+'Cek jaringan BANGSAT!..')
      try:
            get('https://github.com')
      except requests.exceptions.ConnectionError:
            print(lg+'Astaghfirullah.. Maaf Yah,Pakai Tools Ini Tergantung Amal')
            exit()
      print(lg+'Mengupdate..\nLama tidaknya tergantung Amal Ibadah Dan Kuota, sabarr :)')
      
      os.system('cd .. && rm -rf sholat')     
      sp.call(['cd .. && git clone https://github.com/19LhansBeutik33/sholat'],shell=True, stdout=sp.DEVNULL,stderr=sp.STDOUT)
...
{lg}Terimakasih : {lw}Allah SWT
              RED HAT, 19LhansBeutik33 dan semua
              umat Muslim seplanet bumi.
{lg}NB          : {lw}Manusia nggak ada yang sempurna,
              Kecuali "ROKOK SAMPOERNA".
              Silahkan laporkan kritik atau saran
              ke:  - Gabungan Cyber Red Hat : 083137645765
                   - https://facebook.com/Lhans Beutik
                   - sangtopimerah@gmail.com''')
...
def exit():
      print(lg+'_'*63)
      print('Makasih ustadz/ustadzah,\nSemoga sehat selalu  👍🤫,By:Red💘Hat🤠'+x)
